        ...
        switch (StoryType) {
            case "Main":
                ...
                PrintStoryText(6,"主线1-2 风吹白花\n" +
                        ...
                        "“‘生活’？”少年对少女的说法有些不太理解，“生活”不就是一个很普通的名词吗？\n" +
                        "“所谓‘生活’，就是创造出那座纵贯天地的高塔的存在。”少女解释道，\n" +
                        "“它是支配情绪和命运的存在，也是人们信仰的神明之一。自从那座高塔出现以来，大陆上就出现了很多的消极和负面事件。与此同时，也传出更多因为‘霉运’而死伤的例子。这些线索都将罪状指向了‘生活’，它也就渐渐失去了人们的信仰，成为了人们的口中的‘邪神’。”\n" +
                        "“没有人出面阻止它吗？”少年提问道。\n" +
                        "“当然是有的，但是因为人神的巨大差异，结果大多都不尽如人意。其中，”少女顿了一会，“也不乏被‘引导’的勇者。”\n" +
                        "听到这里，少年感到些许不安。少女看出来了他的心思，继续说道：“勇者的责任是维护正义，为了承担这样的责任，许多人付出了巨大的代价。但是我们，‘引导者’也很无奈。一般人根本没有战斗能力，而勇者就是我们对抗邪恶的最大依仗。况且，还记得吗，勇者大人？这是个怎样的世界？”\n" +
                        "“‘游戏化’的世界。”\n" +
                        "“嗯...所以，我最初‘邀请’您的目的，其实不仅仅在于让您享受游戏，还有自己的私心。”少女低下了头，语气里慢慢带上了一些委屈。“我希望，有更多像您一样的英雄，能够挺身而出，拯救大陆和人民于水火之中。”\n" +
                        "“您知道吗，我了解到您被‘生活’的力量所干扰，既兴奋又不安。我很高兴您的实力能够让高高在上的神明也会注意着您，但又担心您会像以前的人们一样，被它无情的抹杀......其实您也可以...”\n" +
                        "少女正欲继续，但少年止住了她的话语。“好了，我既然选择了来到这里，就做好了觉悟。毕竟，你也说，这是勇者的责任。”\n" +
                        "“嗯！”少女的脸上卸下了精神的负担。“我也会好好地‘引导’您，和您携手，拯救世界的。啊，对了......”少女说着话的时候，突然跑开，\n" +
                        "正当少年有些摸不着头脑时，她回来了。手里握着一朵盛开的白花，“从今往后，您就叫我‘白花’吧。即使我的真名没有办法告诉您，但我相信，您一定会有听到我名字的一天。”少女微笑着。\n" +
                        "意外地，这次，“噪音”没有出现。“真是奇怪啊，我在异世界遇见了一个少女，可是我们连彼此的真名都不曾了解，就要一起冒险了......”少年心想着，“那以后请多多指教咯，白花......ちゃん~”少年看她开心了不少，就调侃了她一句。\n" +
                        "少女也凑上前来，靠近少年耳边，\n" +
                        "“はい、お兄ちゃん。”\n");
                break;
            case "Develop":
                ...
                PrintStoryText(1,"1 初衷与命名\n" +
                        ...
                        "在确定TODO类的APP类型后，“问答”成为了这个APP的着力点，因为其初衷如此，我也希望它能始终继承这一理念。\n" +
                ...
                PrintStoryText(3,"3 下期预告：APP重构和挑战\n" +
                        "未完待续......");
                break;
            case "SubLine":
