...
public class ShopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LessGoodButton.setOnClickListener(v -> {
            if(GoodNumber > 1){
        ...
        MoreGoodButton.setOnClickListener(v -> {
            GoodNumber = GoodNumber + 1;
            GoodNumberShowView.setText(GoodNumber + "");
            CalculateGoodPrice();
        });
        ...
        TakeGood1View.setOnClickListener(v -> {
        ...
        TakeGood2View.setOnClickListener(v -> {
            CloseLimitGoodChoose();
        ...
        TakeLimited1View.setOnClickListener(v -> {
