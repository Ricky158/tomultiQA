...
public class MarketActivity extends AppCompatActivity {
    ...
    private void MarketPriceChange(){
        ...
        }while(BoxPriceChanged < 0 && KeyPriceChanged < 0);//if both of them are false (all > 0), stop circulation, continue process. Or calculate again.
        ...
        dialog.setPositiveButton(
                ...
                (dialog1, id) -> {//3.do buying work.
                    ...
                    if(ItemType.equals("Box") && UserPoint >= BoxMarketPrice * BuyNumber){
                        ...
                        Toast.makeText(getApplicationContext(), getString(R.string.NotEnoughPointTran), Toast.LENGTH_SHORT).show();
                    }
                    dialog1.cancel();
                });
        dialog.setNegativeButton(getString(R.string.CancelWordTran),
        ...
        dialog.setPositiveButton(
                ...
                (dialog1, id) -> {//3.do selling work.
                    ...
                    if(ItemType.equals("Box") && UserBoxNumber >= CostNumber){
                        ...
                        Toast.makeText(getApplicationContext(), getString(R.string.NotEnoughItemTran), Toast.LENGTH_SHORT).show();
                    }
                    dialog1.cancel();
                });
        dialog.setNegativeButton(getString(R.string.CancelWordTran),
