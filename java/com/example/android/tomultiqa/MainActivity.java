...
public class MainActivity extends AppCompatActivity {
    ...
    public void ShowQuestHint(View view){
        ...
        if(IsShowHintEnabled){
            ...
            //Toast.makeText(MainActivity.this, getString(R.string.NoteAndHintErrorTran), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void CloseBattle(boolean IsWin){
        ...
        ConstraintLayout BattleInfLayout = findViewById(R.id.BattleInfLayout);
        ConstraintLayout BossSkillLayout = findViewById(R.id.BossSkillLayout);
        ...
        BossSkillLayout.setVisibility(View.GONE);
...
//                }//not necessary, we can edit Turn number in boss design.
    ...
    private void PrintEXPData(){
        ...
        NowHaveEXPView.setText(expIO.UserHaveEXP +"");
        NowLevel.setText(expIO.UserLevel + "");
        ...
        if(expIO.UserLevel >= expIO.LevelLimit){
            ...
            NextLevelEXPView.setText(expIO.UserUpgradeEXP + "");
        }
        //3.And show the result to user.
        EXPrateView.setText(SupportClass.CalculatePercent(expIO.UserHaveEXP,expIO.UserUpgradeEXP) + "%");
        EXPBarView.setProgress(SupportClass.CalculatePercent(expIO.UserHaveEXP,expIO.UserUpgradeEXP) );
