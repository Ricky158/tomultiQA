...
//    }//end of Initializing RecyclerView.
    ...
    String EventName = "";
    String EventScript = "";
    double EventEffect = 1.0;

    private void LoadEvent(){
        if(getIntent().getStringExtra("EventName").equals(getString(R.string.ShopSaleEventTran))){
            EventName = getString(R.string.ShopSaleEventTran);
            EventScript = getIntent().getStringExtra("EventScript");
            EventEffect = 0.75;//25% off.
        }
    }//end of Event system.
    ...
    private class LetterAdapter extends RecyclerView.Adapter<VH> {
        ...
        public void onBindViewHolder(@NonNull VH holder, int position) {//bind (combine) data with [each] item in RecyclerView.
            ...
            holder.ItemNameView.setOnClickListener(v -> {//do something after Clicked.
                ...
                SelectedGoodNameView.setText(NameString + "\n\n" + getString(R.string.SinglePriceWordTran) + "\n" + getGoodPrice(NameString) + getString(R.string.PointWordTran));
