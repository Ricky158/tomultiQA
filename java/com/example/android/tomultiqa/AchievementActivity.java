...
public class AchievementActivity extends AppCompatActivity {
    ...
    private void InitializingAchievement(){
        ...
        UserTourneyPt = SupportClass.getLongData(this,"TourneyDataFile","MaxPtRecord",0);
        LoadNormalAchievement();
        LoadHardAchievement();
    }
    ...
    @SuppressLint("SetTextI18n")
    private void PrintTourneyAchievement(int AchievementID, long RequirePt, String Achievement){
