...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //3.1 prepare RecyclerView object.
        RecyclerView ToDoListView = findViewById(R.id.ToDoListView);
        //3.2 enable system default animation for entire RecyclerView.
    ...
    private void InitializingTimerData(){
        Thread TimerLoad = new Thread(() -> {
            ...
            IsAutoDeleted = SupportClass.getBooleanData(this,"TimerSettingProfile","ToDoAutoDelete",false);//load function.
    ...
    private void ShowTimerNotification(){
        ...
        SignedDay = AppDay;
        SupportClass.saveIntData(this,"TimerSettingProfile","SignDay",SignedDay);
    ...
    public void ListSettingEntry(View view){
        ...
        dialog.setNeutralButton(
                ...
                (dialog13, which) -> SupportClass.CreateNoticeDialog(this,
                        getString(R.string.HelpWordTran),
