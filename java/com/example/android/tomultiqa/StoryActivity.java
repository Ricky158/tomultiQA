...
public class StoryActivity extends AppCompatActivity {
    ...
    static int DeveloperStoryLimit = 5;
    ...
    private void LoadStoryText(){
        ...
        switch (StoryType) {
            ...
            case "Develop":
                ...
                PrintStoryText(5,"4 新功能设计\n" +
                        "各位好，许久不见。本期《开发者漫谈》和各位分享的是新功能的设计思路。\n" +
                        "tomultiQA的新功能是怎样设计的？从我本人看来，主要有以下几个方面：\n" +
                        "##一是“实用性”，\n" +
                        "一个问答App，必须以实用性作前提。回看过去数个版本的更新，您可以发现我最近都在和一些必要的功能作斗争：\n" +
                        "比如备份系统，我想要实现的效果，是App可以接过用户的多数负担，只需要一个文件，一键点“下一步”就可以备份。不需要用户想太多。\n" +
                        "为了实现这个目标，我花了很长时间才做出了一个相对合适的实现。\n" +
                        "类似这样的事情有很多，比如：\n" +
                        "#为什么“日程”的备份只能复制文本，不能导出文件？\n" +
                        "首先，这个东西缺少统一的标准，兼容自己的App的文件对于其他App是完全无用的。\n" +
                        "其次，要考虑到，用户不一定是什么专业人士，移动端的用户对“文件”的概念相对模糊。\n" +
                        "但是，如果将“事项”的文本复制导出，既方便用户分享，用户可以自己挑出重要的内容；\n" +
                        "也方便存储，至少用户不会将这些重要资料随意丢在储存里，然后废弃。而可以放入便签，方便管理。\n" +
                        "最后，也是我本人的水平问题，您看，备份功能我花了许久才将它做成现在这个勉强能用的样子。您让我再写一个新的，我想我也不一定还记得怎样做了。\n" +
                        "在这种情况下，这种针对“实用性”的折中就成为了必然。\n" +
                        "##二是“简易性”，\n" +
                        "我在编程这件事上完全是半路出家。突发奇想就开始刷网课，敲代码的。\n" +
                        "因此，我发现，自己的应用相较同类缺失了不少东西；虽然我本人其实也希望自己的App能够更加炫酷，拥有好看的动效和漂亮的UI。\n" +
                        "但是，实在是无从下手。这辈子没接触过专业开发，对编程的很多概念一无所知。\n" +
                        "#比如支持库，框架，各种xml文件，我至今都没完全弄明白它们是怎样使用的。\n" +
                        "毕竟，App里的不少代码，都是我一边搜索，一边查文档整出来的。它们能够正常工作，我就已经筋疲力尽，更别提这些进阶需求了。\n" +
                        "也就是因为这样薄弱的基础，我脑子里的很多想法最终都只能废弃，或者是大幅缩水。\n" +
                        "##三是“协调性”，\n" +
                        "新功能本身是不能够和App的“主题”，与我的“期望”违和的。\n" +
                        "我希望自己能够学习市场上的很多App的优点，摒弃掉他们的缺点：\n" +
                        "#比如，作为“日常关卡”的“望晨崖”，从一开始就有扫荡功能。帮助用户免去重复挑战。\n" +
                        "还有，战斗时，为什么只有boss，没有玩家？这是因为，如果玩家专注于放技能，注意双方HP，状态这些事务，就会干扰“学习”这个主题；\n" +
                        "再加上我们是竖屏App，为了保障用户的虚拟键盘能够一直保持在屏幕，不用上上下下的收放，又要浪费掉屏幕下半的空间。\n" +
                        "最后，经过妥协，传统的回合制战斗，双方的你来我往，到这里就阉割剩下了boss的独角戏。\n" +
                        "而且，相信您也能在更新公告看到，App的UI在不停的调整，就是因为类似这样的原因。\n" +
                        "最近的更新将主页面的很多元素由文本或按钮换成图标也是类似的道理，加强页面元素之间的对比度，突出重点，减少干扰。\n" +
                        "##最后，我想说：\n" +
                        "很多看似精彩或美好的设计在我们这类特殊场景下，就会变成追求实用和游戏性的妥协。\n" +
                        "我们不能让tomultiQA变成真正的游戏，无论是从目标上，还是实践上。但是，我们希望从现有的优秀范例里提炼精华加入更新。\n" +
                        "这样的想法，就慢慢成为了tomultiQA的功能设计。");
                break;
            case "SubLine":
