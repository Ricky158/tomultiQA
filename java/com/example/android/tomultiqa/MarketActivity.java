    ...
    public void BuyMarketItem(View view){
        ...
        dialog.setPositiveButton(
                ...
                (dialog1, id) -> {//3.do buying work.
                    ...
                    if(ItemType.equals("Box") && UserPoint >= BoxMarketPrice * BuyNumber && UserBoxNumber <= ITEM_NUMBER_LIMIT){
                        CostPoint(BoxMarketPrice * BuyNumber);
                        GetBox(BuyNumber);
                    }else if(ItemType.equals("Key") && UserPoint >= KeyMarketPrice * BuyNumber && UserKeyNumber <= ITEM_NUMBER_LIMIT){
